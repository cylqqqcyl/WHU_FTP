import threading
import json
from client.frontend import ProcessBar as PB
...
class Client:
    def __init__(self):
        ...
        # 远程文件目录的icon
        cur_dir = os.getcwd()
        icon_dir_path = os.path.join(cur_dir, '../STATUS/resources/common/directory.png')
        icon_file_path = os.path.join(cur_dir, '../STATUS/resources/common/text.png')
        icon_ukn_path = os.path.join(cur_dir, '../STATUS/resources/common/unknown.png')
        self.icon_dir = QIcon()
