...
"background-color: rgba(0, 170, 255, 150);")
        ...
        self.tsButton = QtWidgets.QPushButton(self.frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.tsButton.sizePolicy().hasHeightForWidth())
        self.tsButton.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        self.tsButton.setFont(font)
        self.tsButton.setStyleSheet("background-color: rgba(255, 255, 255, 200);")
        self.tsButton.setObjectName("tsButton")
        self.verticalLayout_2.addWidget(self.tsButton)
...
"background-color: rgba(128, 128, 128, 150);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tsButton.setText(_translate("MainWindow", "传输列表"))
