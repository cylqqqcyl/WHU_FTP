...
from frontend.NewLogin import NewLogin_Form
import queue
...
class Client:
    def __init__(self):
        ...
        # 远程文件目录的icon
        cur_dir = os.getcwd()
        icon_dir_path = os.path.join(cur_dir, 'frontend/resources/common/directory.png')
        icon_file_path = os.path.join(cur_dir, 'frontend/resources/common/text.png')
        icon_ukn_path = os.path.join(cur_dir, 'frontend/resources/common/unknown.png')
        self.icon_dir = QIcon()
    ...
    def download(self):
        if self.local_dir or self.download_closing_event.is_set():
    ...
    def upload(self):
        if self.local_file or self.upload_closing_event.is_set():
            if self.upload_closing_event.is_set():
